package net.getquicker.hook.permission;


import static net.getquicker.hook.PermConst.PACKAGE_PERMISSIONS;

import android.os.Build;

import androidx.annotation.RequiresApi;

import net.getquicker.hook.BaseSubHook;
import net.getquicker.hook.XLog;
import net.getquicker.hook.helper.MethodHookWrapper;
import net.getquicker.hook.helper.XposedWrapper;
